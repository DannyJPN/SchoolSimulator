...
- Aktivita se typicky znamkuje jen v extremech `1` nebo `5`.
- Testy a ukoly mohou obsahovat:
  - doplnovani
  - diktat
  - pocetni priklady
...
- U pocetnich prikladu se sleduje:
  - `postup`
  - `vysledek`
- NPC ucitel hodnoti oboji zvlast.
- Hrac-ucitel rozhoduje sam.

## Oralni odpovedi

- Zak ma na ustni odpoved `30 sekund` realneho casu.
- U kratke jednotlive otazky mimo plne zkouseni:
  - spatna odpoved muze vest k napomenuti nebo mensimu trestu
  - NPC ucitel o tom rozhoduje podle povahy
- Pri plnem zkouseni u tabule:
  - vysledkem je znamka
  - nasledne muze prijit domaci trest od rodicu

## Domaci ukoly

- Domaci ukol je na `pristi hodinu stejneho predmetu`.
- Pokud je odevzdan pozde:
  - zalezi na rozhodnuti ucitele
  - muze dostat i `5 bez kontroly`
- Odevzdani pozde neni automaticky omluvitelne.

## Opravne prezkouseni

- Zak o nej muze poprosit `kdykoli`.
- Prosba smeruje ke `konkretni znamce z konkretni aktivity`.
- Mozna je jen u znamky `horsi nez 1`.
- Ucitel muze prosbu `odmitnout`.
- S kazdou dalsi prosbou v pololeti klesa sance na uspech.
- Pocita se to `globalne za pololeti`, ne po predmetech.
- Po prijeti prosby vznikne `nova dalsi znamka`, nenahrazuje puvodni.
- Pokud je prosba odmitnuta:
  - NPC zak se vzdy omluvi
  - hrac-zak ma na omluvu `20 sekund`
  - neomluveni snizi kazen

## Vahy znamek

- Pro znamky existuji `defaultni vahy`.
- Jsou spolecne pro typ aktivity napric predmety, ktere danou aktivitu pouzivaji.
- V `nastaveni hry` pujdou zmenit.
- NPC ucitel pouziva nastaveni hry.
- Hrac-ucitel muze pro konkretni aktivitu v konkretni situaci vahu zmenit.
...
- Body urcuji navrh znamky z kazne.
- Hrac-zak body nevidi.
- Hrac-zak vidi:
  - historii
...
- Kazen se meni:
  ...
  - priznanim
  - nespravedlivym trestem

## Vahy kazenskych udalosti

- Udalosti kazne maji pevne `vahy`.
- Vahy jsou `globalni pro celou hru`.
- Nejsou nastavitelne hracem.
- Napomenuti ma nizkou negativni vahu.
- Pochvala ma kladnou vahu.
- Priznani ma kladnou vahu, i kdyz neni samostatna pochvala.

## Napomenuti

- Je samostatna kazenska udalost s nizkou vahou.
- Zapisuje se do:
  - tridni knihy
  - historie kazne
...
- Kazdy trest ma informaci, kdo ho smi udelit:
  - `jen ucitel`
  - `jen rodice`
  - `oba`
...
- Znamkovani predmetu je `1-5`.
- Kazen je take `1-5`.
- `Kazen 5` = `vylouceni`.
- Na vysvedceni je i `pocet zameskanych hodin`.

## Dochazka

- Absence se sleduje po `hodinach`.
